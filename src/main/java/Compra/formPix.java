...
public class formPix extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Metodo de pagamento: Pix");
        ...
        jPanel4.setBackground(new java.awt.Color(232, 221, 203));

        jLabel2.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(3, 54, 73));
        jLabel2.setText("Aponte a câmera do seu celular ");

        jLabel3.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(3, 54, 73));
        jLabel3.setText("ao QR Code para realizar o pagamento.");

        jLabel4.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(3, 54, 73));
        jLabel4.setText("Após a realização do pagamento");

        jLabel5.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(3, 54, 73));
        jLabel5.setText("aperte o botão abaixo para finalizar o pedido");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(44, 44, 44)
                .addComponent(QRfoto, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalizarActionPerformed
        formFinalizacao finalizacao = new formFinalizacao();
        finalizacao.carrinho = carrinho;
        finalizacao.setValor(carrinho.valorTotalPub * 0.9);
        finalizacao.mudarEstoque();
    ...
    public void setImagem(){
        ImageIcon imageIcon = new ImageIcon("PixConcluido.png");
        Image image = imageIcon.getImage();
        Image newImg = image.getScaledInstance(200, 200, java.awt.Image.SCALE_SMOOTH);
        imageIcon = new ImageIcon(newImg);
        QRfoto.setIcon(imageIcon);
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel QRfoto;
